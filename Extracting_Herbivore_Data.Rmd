...
Top_Species_Overall_By_Gear_Atlantic_Trophic_Levels=plyr::join(as.data.frame(Top_Species_Overall_By_Gear),species_list_modified[c(5,2,4:7,9:12)],by=c("NODCCODE","Commonname"),type="left")
